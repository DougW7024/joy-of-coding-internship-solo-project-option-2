...
var require_FetchConfigProvider = __commonJS({
  "../node_modules/@redwoodjs/web/dist/components/FetchConfigProvider.js"(exports) {
    "use strict";
    ...
    var FetchConfigContext = exports.FetchConfigContext = _react.default.createContext({
      uri: getApiGraphQLUrl()
    });
    var FetchConfigProvider = (_ref) => {
      let {
      ...
      if (!isAuthenticated) {
        return (0, _jsxRuntime.jsx)(FetchConfigContext.Provider, {
          value: {
            uri: getApiGraphQLUrl()
          },
          ...rest
    ...
    var useFetchConfig = () => _react.default.useContext(FetchConfigContext);
...
var require_GraphQLHooksProvider = __commonJS({
  "../node_modules/@redwoodjs/web/dist/components/GraphQLHooksProvider.js"(exports) {
    "use strict";
    var _Object$defineProperty = require_define_property();
    var _interopRequireDefault = require_interopRequireDefault().default;
    _Object$defineProperty(exports, "__esModule", {
    ...
    var _react = _interopRequireDefault(require_react());
    var _jsxRuntime = require_jsx_runtime();
    var GraphQLHooksContext = exports.GraphQLHooksContext = _react.default.createContext({
      useQuery: () => {
    ...
    var GraphQLHooksProvider = (_ref) => {
      let {
        useQuery: useQuery3,
        useMutation: useMutation3,
        useSubscription: useSubscription3,
        children
      } = _ref;
      return (0, _jsxRuntime.jsx)(GraphQLHooksContext.Provider, {
        value: {
          useQuery: useQuery3,
          useMutation: useMutation3,
          useSubscription: useSubscription3
...
var require_concat4 = __commonJS({
  "../node_modules/core-js-pure/actual/instance/concat.js"(exports, module2) {
    "use strict";
...
var require_concat5 = __commonJS({
  "../node_modules/core-js-pure/full/instance/concat.js"(exports, module2) {
    "use strict";
...
var require_concat6 = __commonJS({
  "../node_modules/core-js-pure/features/instance/concat.js"(exports, module2) {
    "use strict";
    module2.exports = require_concat5();
  }
});

// ../node_modules/@babel/runtime-corejs3/core-js/instance/concat.js
var require_concat7 = __commonJS({
  "../node_modules/@babel/runtime-corejs3/core-js/instance/concat.js"(exports, module2) {
    module2.exports = require_concat6();
  }
});
...
var init_canUse = __esm({
  "../node_modules/@apollo/client/utilities/common/canUse.js"() {
    ...
    canUseWeakMap = typeof WeakMap === "function" && !maybe(function() {
      return navigator.product == "ReactNative" && !globalThis.HermesInternal;
    });
  ...
  "../node_modules/@apollo/client/core/QueryManager.js"() {
    ...
    function() {
      function QueryManager2(_a2) {
        var cache2 = _a2.cache, link = _a2.link, defaultOptions3 = _a2.defaultOptions, documentTransform = _a2.documentTransform, _b = _a2.queryDeduplication, queryDeduplication = _b === void 0 ? false : _b, onBroadcast = _a2.onBroadcast, _c = _a2.ssrMode, ssrMode = _c === void 0 ? false : _c, _d = _a2.clientAwareness, clientAwareness = _d === void 0 ? {} : _d, localState = _a2.localState, _e = _a2.assumeImmutableResults, assumeImmutableResults = _e === void 0 ? !!cache2.assumeImmutableResults : _e, defaultContext = _a2.defaultContext;
        var _this = this;
  ...
  "../node_modules/@apollo/client/core/ApolloClient.js"() {
    ...
    function() {
      function ApolloClient2(options) {
        ...
        var uri = options.uri, credentials = options.credentials, headers = options.headers, cache2 = options.cache, documentTransform = options.documentTransform, _a2 = options.ssrMode, ssrMode = _a2 === void 0 ? false : _a2, _b = options.ssrForceFetchDelay, ssrForceFetchDelay = _b === void 0 ? 0 : _b, _c = options.connectToDevTools, connectToDevTools = _c === void 0 ? typeof window === "object" && !window.__APOLLO_CLIENT__ && globalThis.__DEV__ !== false : _c, _d = options.queryDeduplication, queryDeduplication = _d === void 0 ? true : _d, defaultOptions3 = options.defaultOptions, defaultContext = options.defaultContext, _e = options.assumeImmutableResults, assumeImmutableResults = _e === void 0 ? cache2.assumeImmutableResults : _e, resolvers = options.resolvers, typeDefs = options.typeDefs, fragmentMatcher = options.fragmentMatcher, clientAwarenessName = options.name, clientAwarenessVersion = options.version;
...
var React, contextKey, resetApolloContext;
...
var React5, didWarnUncachedGetSnapshot, uSESKey, realHook, useSyncExternalStore;
...
var React10, useKey, realHook2, __use;
var init_use = __esm({
  "../node_modules/@apollo/client/react/hooks/internal/__use.js"() {
    init_utilities();
...
var React11, hasOwnProperty9, InternalState;
  ...
  "../node_modules/@apollo/client/react/hooks/useQuery.js"() {
    ...
    function() {
      ...
      InternalState2.prototype.createWatchQueryOptions = function(_a2) {
        ...
        var skip = _a2.skip, ssr = _a2.ssr, onCompleted = _a2.onCompleted, onError = _a2.onError, defaultOptions3 = _a2.defaultOptions, otherOptions = __rest(_a2, ["skip", "ssr", "onCompleted", "onError", "defaultOptions"]);
...
var QUERY_REFERENCE_SYMBOL, PROMISE_SYMBOL, OBSERVED_CHANGED_OPTIONS, InternalQueryReference;
...
var persisted_queries_exports = {};
__export(persisted_queries_exports, {
  VERSION: () => VERSION,
...
function processErrors(graphQLErrors) {
  ...
  if (isNonEmptyArray(graphQLErrors)) {
    graphQLErrors.forEach(function(error) {
      ...
      if (typeof ((_a2 = error.extensions) === null || _a2 === void 0 ? void 0 : _a2.code) == "string")
...
var VERSION, defaultOptions2, createPersistedQueryLink;
var init_persisted_queries = __esm({
  "../node_modules/@apollo/client/link/persisted-queries/index.js"() {
    init_tslib_es6();
    init_globals();
    init_utilities();
    ...
    createPersistedQueryLink = function(options) {
      var hashesByQuery;
      function resetHashCache() {
        hashesByQuery = void 0;
      }
      invariant2(options && (typeof options.sha256 === "function" || typeof options.generateHash === "function"), 40);
      var _a2 = compact(defaultOptions2, options), sha256 = _a2.sha256, _b = _a2.generateHash, generateHash = _b === void 0 ? function(query) {
        return Promise.resolve(sha256(print2(query)));
      } : _b, disable = _a2.disable, retry = _a2.retry, useGETForHashedQueries = _a2.useGETForHashedQueries;
      ...
      return Object.assign(new ApolloLink(function(operation, forward) {
        ...
        return new Observable(function(observer) {
          ...
          var maybeRetry = function(_a3, cb) {
            var response = _a3.response, networkError = _a3.networkError;
          ...
          if (useGETForHashedQueries && supportsPersistedQueries && !operationDefinesMutation(operation)) {
            operation.setContext(function(_a3) {
              var _b2 = _a3.fetchOptions, fetchOptions = _b2 === void 0 ? {} : _b2;
        ...
        getMemoryInternals: function() {
          ...
          return {
            PersistedQueryLink: {
              persistedQueryHashes: (_a3 = hashesByQuery === null || hashesByQuery === void 0 ? void 0 : hashesByQuery.size) !== null && _a3 !== void 0 ? _a3 : 0
            }
          };
        }
      } : {});
...
var require_typeOverride = __commonJS({
  "../node_modules/@redwoodjs/web/dist/apollo/typeOverride.js"(exports) {
    "use strict";
    var _Object$defineProperty = require_define_property();
    _Object$defineProperty(exports, "__esModule", {
      value: true
...
var require_fragmentRegistry = __commonJS({
  "../node_modules/@redwoodjs/web/dist/apollo/fragmentRegistry.js"(exports) {
    "use strict";
    var _Object$defineProperty = require_define_property();
    ...
    var apolloClient = _interopRequireWildcard((init_client(), __toCommonJS(client_exports)));
    var _cache = (init_cache2(), __toCommonJS(cache_exports));
    var _utilities = (init_utilities(), __toCommonJS(utilities_exports));
    ...
    var fragmentRegistry = exports.fragmentRegistry = (0, _cache.createFragmentRegistry)();
...
var require_function_bind = __commonJS({
  "../node_modules/core-js-pure/internals/function-bind.js"(exports, module2) {
    "use strict";
...
var require_bind = __commonJS({
  "../node_modules/core-js-pure/es/function/virtual/bind.js"(exports, module2) {
    "use strict";
    require_es_function_bind();
    var getBuiltInPrototypeMethod = require_get_built_in_prototype_method();
    module2.exports = getBuiltInPrototypeMethod("Function", "bind");
  }
});

// ../node_modules/core-js-pure/es/instance/bind.js
var require_bind2 = __commonJS({
  "../node_modules/core-js-pure/es/instance/bind.js"(exports, module2) {
    "use strict";
    var isPrototypeOf = require_object_is_prototype_of();
...
var require_bind3 = __commonJS({
  "../node_modules/core-js-pure/stable/instance/bind.js"(exports, module2) {
    "use strict";
...
var require_bind4 = __commonJS({
  "../node_modules/core-js-pure/actual/instance/bind.js"(exports, module2) {
    "use strict";
...
var require_bind5 = __commonJS({
  "../node_modules/core-js-pure/full/instance/bind.js"(exports, module2) {
    "use strict";
...
var require_bind6 = __commonJS({
  "../node_modules/core-js-pure/features/instance/bind.js"(exports, module2) {
    "use strict";
    module2.exports = require_bind5();
  }
});

// ../node_modules/@babel/runtime-corejs3/core-js/instance/bind.js
var require_bind7 = __commonJS({
  "../node_modules/@babel/runtime-corejs3/core-js/instance/bind.js"(exports, module2) {
    module2.exports = require_bind6();
  }
});
...
var require_handler = __commonJS({
  "../node_modules/graphql-sse/lib/handler.js"(exports) {
    ...
    function createHandler(options) {
      const { validate = graphql_1.validate, execute: execute2 = graphql_1.execute, subscribe = graphql_1.subscribe, schema, authenticate = function extractOrCreateStreamToken(req) {
        var _a2;
      ...
      function createStream(token) {
        ...
        return {
          ...
          from(ctx, req, result2, opId) {
            (async () => {
              if ((0, common_1.isAsyncIterable)(result2)) {
                for await (let part of result2) {
                ...
                const maybeResult = await (onNext === null || onNext === void 0 ? void 0 : onNext(ctx, req, result2));
                if (maybeResult)
                  result2 = maybeResult;
                msgs.next((0, common_1.print)({
                  event: "next",
      ...
      async function prepare(req, params) {
        ...
        if (isResponse(onSubscribeResult))
          ...
          const { operationName: operationName2, variables } = params;
          let query;
          try {
        ...
        return {
          ctx: args.contextValue,
          async perform() {
            const result2 = await (operation === "subscription" ? subscribe(args) : execute2(args));
            const maybeResult = await (onOperation === null || onOperation === void 0 ? void 0 : onOperation(args.contextValue, req, args, result2));
            if (maybeResult)
              return maybeResult;
            return result2;
          }
      ...
      return async function handler(req) {
        ...
        if (accept === "text/event-stream") {
          ...
          if (!stream) {
            ...
            if (isResponse(prepared2))
              return prepared2;
            const result3 = await prepared2.perform();
            if ((0, common_1.isAsyncIterable)(result3))
              distinctStream.ops[""] = result3;
            distinctStream.from(prepared2.ctx, req, result3, null);
            return [
        ...
        const result2 = await prepared.perform();
        if (!(opId in stream.ops)) {
          if ((0, common_1.isAsyncGenerator)(result2))
            result2.return(void 0);
          if (!(opId in stream.ops)) {
            return [
              null,
              {
        ...
        if ((0, common_1.isAsyncIterable)(result2))
          stream.ops[opId] = result2;
        stream.from(prepared.ctx, req, result2, opId);
    ...
    function createParser() {
      ...
      return function parse(chunk) {
        if (buffer === void 0) {
          ...
          const concat2 = new Uint8Array(buffer.length + chunk.length);
          concat2.set(buffer);
          concat2.set(chunk, buffer.length);
          buffer = concat2;
        }
          ...
          (async () => {
            ...
            for (; ; ) {
              try {
                ...
                for await (const result2 of getResults()) {
                  retryingErr2 = null;
                  retries2 = 0;
                  sink.next(result2);
                }
...
var require_sseLink = __commonJS({
  "../node_modules/@redwoodjs/web/dist/apollo/sseLink.js"(exports) {
    "use strict";
    var _Object$defineProperty = require_define_property();
    var _interopRequireDefault = require_interopRequireDefault().default;
    _Object$defineProperty(exports, "__esModule", {
    ...
    var _core = (init_core2(), __toCommonJS(core_exports));
    var _graphql = (init_graphql(), __toCommonJS(graphql_exports));
    var _graphqlSse = require_lib();
    ...
    var SSELink = class extends _core.ApolloLink {
      constructor(options) {
        super();
        this.client = void 0;
        const {
        ...
        const {
          ...
          referrer,
          referrerPolicy
        } = (httpLinkConfig == null ? void 0 : httpLinkConfig.headers) || {};
...
var require_useCache = __commonJS({
  "../node_modules/@redwoodjs/web/dist/apollo/useCache.js"(exports) {
    "use strict";
    var _Object$defineProperty = require_define_property();
    _Object$defineProperty(exports, "__esModule", {
      value: true
    ...
    var _client = (init_client(), __toCommonJS(client_exports));
    var useCache = () => {
      const client = (0, _client.useApolloClient)();
      const cache2 = client.cache;
      const extract = function() {
        let optimistic = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
        return cache2.extract(optimistic);
      };
      const identify = (object) => {
        return {
          id: cache2.identify(object)
        };
      };
      const modify = (object, fields) => {
        return cache2.modify({
          ...identify(object),
          fields
        });
      };
      const evict = (object) => {
        return cache2.evict(identify(object));
      };
      const resetStore = () => {
...
var require_apollo = __commonJS({
  "../node_modules/@redwoodjs/web/dist/apollo/index.js"(exports) {
    "use strict";
    var _Object$defineProperty = require_define_property();
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    var _interopRequireDefault = require_interopRequireDefault().default;
    ...
    var _react = _interopRequireDefault(require_react());
    var _map = _interopRequireDefault(require_map());
    var _concat = _interopRequireDefault(require_concat7());
    var _globalThis2 = _interopRequireDefault(require_global_this());
    var apolloClient = _interopRequireWildcard((init_client(), __toCommonJS(client_exports)));
    var _context3 = (init_context3(), __toCommonJS(context_exports));
    var _persistedQueries = (init_persisted_queries(), __toCommonJS(persisted_queries_exports));
    var _utilities = (init_utilities(), __toCommonJS(utilities_exports));
    var _printer = (init_printer(), __toCommonJS(printer_exports));
    var _auth = require_cjs();
    require_typeOverride();
    var _FetchConfigProvider = require_FetchConfigProvider();
    var _GraphQLHooksProvider = require_GraphQLHooksProvider();
    var _fragmentRegistry = require_fragmentRegistry();
    var _sseLink = require_sseLink();
    var _useCache = require_useCache();
    var _jsxRuntime = require_jsx_runtime();
    var {
      ApolloProvider: ApolloProvider2,
      ApolloClient: ApolloClient2,
      ApolloLink: ApolloLink2,
      HttpLink: HttpLink2,
      InMemoryCache: InMemoryCache2,
      useQuery: useQuery2,
      useMutation: useMutation2,
      useSubscription: useSubscription2,
      setLogVerbosity: apolloSetLogVerbosity
    } = apolloClient;
    var ApolloProviderWithFetchConfig = (_ref) => {
      var _context2;
      let {
        config,
        children,
      ...
      const updateDataApolloLink = new ApolloLink2((operation, forward) => {
        var _context;
        const {
          operationName: operationName2,
          query,
        ...
        return (0, _map.default)(_context = forward(operation)).call(_context, (result2) => {
          data.mostRecentResponse = result2;
          return result2;
        });
      });
      ...
      const authMiddleware = new ApolloLink2((operation, forward) => {
        const {
          token
      ...
      link ?? (link = ApolloLink2.from((0, _map.default)(redwoodApolloLinks).call(redwoodApolloLinks, (l) => l.link)));
      if (typeof link === "function") {
        link = link(redwoodApolloLinks);
      }
      const client = new ApolloClient2({
      ...
      return (0, _jsxRuntime.jsx)(ApolloProvider2, {
        client,
        children: (0, _jsxRuntime.jsx)(ErrorBoundary, {
          onError: extendErrorAndRethrow,
          children
        })
      });
    };
    var ErrorBoundary = class extends _react.default.Component {
      componentDidCatch() {
        this.setState({});
    ...
    var RedwoodApolloProvider = (_ref4) => {
      var _a2;
      ...
      const cache2 = new InMemoryCache2({
        fragments: _fragmentRegistry.fragmentRegistry,
        possibleTypes: cacheConfig == null ? void 0 : cacheConfig.possibleTypes,
        ...cacheConfig
      }).restore((_globalThis$__REDWOOD = (_a2 = _globalThis2.default) == null ? void 0 : _a2.__REDWOOD__APOLLO_STATE) !== null && _globalThis$__REDWOOD !== void 0 ? _globalThis$__REDWOOD : {});
      return (0, _jsxRuntime.jsx)(_FetchConfigProvider.FetchConfigProvider, {
        useAuth,
        children: (0, _jsxRuntime.jsx)(
          ApolloProviderWithFetchConfig,
          {
            ...
            useAuth,
            logLevel,
            children: (0, _jsxRuntime.jsx)(_GraphQLHooksProvider.GraphQLHooksProvider, {
              useQuery: useQuery2,
              useMutation: useMutation2,
              useSubscription: useSubscription2,
              children
...
//# sourceMappingURL=chunk-ROONVCXJ.js.map
