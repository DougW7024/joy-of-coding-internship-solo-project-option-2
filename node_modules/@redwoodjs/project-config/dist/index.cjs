...
var getPaths = (BASE_DIR = getBaseDir()) => {
  ...
  const paths = {
    ...
    web: {
      ...
      index: resolveFile(import_path2.default.join(BASE_DIR, PATH_WEB_DIR_SRC_INDEX)),
      ...
      webpack: import_path2.default.join(BASE_DIR, PATH_WEB_DIR_CONFIG_WEBPACK),
      viteConfig: resolveFile(import_path2.default.join(BASE_DIR, PATH_WEB_DIR_CONFIG_VITE)),
