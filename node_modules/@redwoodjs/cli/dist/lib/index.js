...
const nameVariants = (name) => {
  const normalizedName = (0, import_pascalcase.default)((0, import_param_case.paramCase)((0, import_rwPluralize.singularize)(name)));
  return {
    pascalName: (0, import_pascalcase.default)((0, import_param_case.paramCase)(name)),
    ...
    singularParamName: (0, import_param_case.paramCase)(normalizedName),
    pluralParamName: (0, import_param_case.paramCase)((0, import_rwPluralize.pluralize)(normalizedName)),
