...
const getSchemaDefinitions = () => {
  return (0, import_internals.getDMMF)({ datamodelPath: (0, import__.getPaths)().api.dbSchema });
};
const getSchemaConfig = () => {
  return (0, import_internals.getConfig)({
    datamodel: import_fs_extra.default.readFileSync((0, import__.getPaths)().api.dbSchema).toString()
  });
};
