...
const getPrettierConfig = () => {
  try {
    return require(import_path.default.join((0, import_project_config.getPaths)().base, "prettier.config.js"));
  } catch (e) {
    return void 0;
  }
};
const prettify = (code, options = {}) => (0, import_prettier.format)(code, {
  singleQuote: true,
  semi: false,
  ...getPrettierConfig(),
  parser: "babel",
