    ...
    [
      {
        ...
        task: () => {
          ...
          const mailerContent = projectIsTypescript ? templateContent : (0, import_lib.transformTSToJS)(mailerPath, templateContent);
      ...
      },
      {
        ...
        task: () => {
          ...
          const exampleTemplateContent = projectIsTypescript ? templateContent : (0, import_lib.transformTSToJS)(exampleTemplatePath, templateContent);
