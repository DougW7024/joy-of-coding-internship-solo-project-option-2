...
var webpackHandler_exports = {};
__export(webpackHandler_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(webpackHandler_exports);
    ...
    [
      {
        ...
        task: () => {
          const webpackConfigFile = `${(0, import_lib.getPaths)().web.config}/webpack.config.js`;
      ...
      },
      {
        ...
        task: (_ctx, task) => {
          ...
          ${import_chalk.default.hex("#e8e8e8")(
