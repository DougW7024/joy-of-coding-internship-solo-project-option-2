  ...
  return [
    {
      ...
      task: () => {
        ...
        const setupScriptContent = ts ? serverFileTemplateContent : (0, import_lib.transformTSToJS)(serverFilePath, serverFileTemplateContent);
        return [
