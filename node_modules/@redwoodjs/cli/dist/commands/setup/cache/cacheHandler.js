    ...
    ),
    {
      ...
      task: (_ctx, task) => {
        task.title = `One more thing...
          ...
          ${import_colors.default.green("Check out the Service Cache docs for config and usage:")}
          ${import_chalk.default.hex("#e8e8e8")("https://redwoodjs.com/docs/services#caching")}
        `;
      }
    }
  ]);
