    ...
    [
      ...
      },
      {
        ...
        task: () => {
          ...
          const sdlContent = ts ? exampleSdlTemplateContent : (0, import_lib.transformTSToJS)(sdlFile, exampleSdlTemplateContent);
          ...
          const serviceContent = ts ? exampleServiceTemplateContent : (0, import_lib.transformTSToJS)(serviceFile, exampleServiceTemplateContent);
          ...
          const setupScriptContent = ts ? exampleSubscriptionTemplateContent : (0, import_lib.transformTSToJS)(exampleFile, exampleSubscriptionTemplateContent);
          return [
            (0, import_lib.writeFile)(
              sdlFile,
              (0, import_lib.generateTemplate)(sdlContent, templateVariables(name)),
              {
            ...
            (0, import_lib.writeFile)(
              serviceFile,
              (0, import_lib.generateTemplate)(serviceContent, templateVariables(name)),
              {
                overwriteExisting: force
              }
            ),
            (0, import_lib.writeFile)(
              exampleFile,
              (0, import_lib.generateTemplate)(setupScriptContent, templateVariables(name)),
              {
                overwriteExisting: force
              }
            )
