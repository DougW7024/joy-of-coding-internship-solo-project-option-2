...
const builder = async (yargs) => {
  yargs.command({
    ...
    if (positionalArgs.length === 1) {
      ...
      if (!import_fs_extra.default.existsSync(import_path.default.join((0, import_lib.getPaths)().api.dist)) || !import_fs_extra.default.existsSync(import_path.default.join((0, import_lib.getPaths)().web.dist), "index.html")) {
        console.error(
          import_colors.default.error(
