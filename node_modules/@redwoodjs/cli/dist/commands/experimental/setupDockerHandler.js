...
var setupDockerHandler_exports = {};
__export(setupDockerHandler_exports, {
  getVersionOfRedwoodPackageToInstall: () => getVersionOfRedwoodPackageToInstall,
  handler: () => handler
});
module.exports = __toCommonJS(setupDockerHandler_exports);
...
async function handler({ force }) {
  const TEMPLATE_DIR = import_path.default.join(__dirname, "templates", "docker");
