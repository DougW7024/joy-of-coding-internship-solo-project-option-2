...
const handler = async (yargs) => {
  ...
  try {
    ...
    if (yargs.firstRun) {
      ...
      console.log();
      console.log(SETUP_MARKER, import_colors.default.green("Starting first setup wizard..."));
      ...
      console.log();
      console.log(SETUP_MARKER, `Found ${import_colors.default.green(deployedApiUrl)}`);
      console.log();
      ...
      if (yargs.sides.includes("web")) {
        ...
        const message = [
          ...
          "",
          `View your deployed site at: ${import_colors.default.green(deployedWebUrl)}`,
          "",
