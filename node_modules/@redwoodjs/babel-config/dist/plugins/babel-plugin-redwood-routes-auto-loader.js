...
function babel_plugin_redwood_routes_auto_loader_default({ types: t }, { forPrerender = false, forVite = false }) {
  ...
  return {
    ...
    visitor: {
      ...
      ImportDeclaration(p) {
        ...
        const defaultSpecifier = p.node.specifiers.filter(
...
function prerenderLoaderImpl(forPrerender, forVite, relativeImport, t) {
  if (forPrerender) {
