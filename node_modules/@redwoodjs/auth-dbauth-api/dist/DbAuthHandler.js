...
class DbAuthHandler {
  get normalizedRequest() {
    if (!this._normalizedRequest) {
      ...
      throw new Error('dbAuthHandler has not been initialised. Either await dbAuthHandler.invoke() or call await dbAuth.init()');
    }
  ...
  get _deleteSessionHeader() {
    return {
      'set-cookie': [`${(0, _shared.cookieName)(this.options.cookie?.name)}=`, ...this._cookieAttributes({
        expires: 'now'
      })
      // `auth-provider=`,
  ...
  async webAuthnAuthenticate() {
    ...
    const cookies = (0, _flat.default)(_context6 = [this._webAuthnCookie(rawId, this.webAuthnExpiresDate), loginHeaders['set-cookie']]).call(_context6);
    return [verified, {
      'set-cookie': cookies
    }];
  }
  ...
  _sanitizeUser(user) {
    ...
    (0, _forEach.default)(_context7 = (0, _keys.default)(sanitized)).call(_context7, key => {
      var _context8;
      if (!(0, _includes.default)(_context8 = this.allowedUserFields).call(_context8, key)) {
  ...
  _cookieAttributes({
    ...
    const meta = (0, _filter.default)(_context9 = (0, _map.default)(_context10 = (0, _keys.default)(cookieOptions)).call(_context10, key => {
  ...
  _createSessionHeader(data, csrfToken) {
    ...
    const cookie = [`${(0, _shared.cookieName)(this.options.cookie?.name)}=${encrypted}`, ...this._cookieAttributes({
  ...
  async _verifyUser(username, password) {
    ...
    if (!username || (0, _trim.default)(_context11 = username.toString()).call(_context11) === '' || !password || (0, _trim.default)(_context12 = password.toString()).call(_context12) === '') {
  ...
  async _getAuthMethod() {
    ...
    if (!(0, _includes.default)(_context13 = DbAuthHandler.METHODS).call(_context13, methodName) && this.normalizedRequest.jsonBody) {
