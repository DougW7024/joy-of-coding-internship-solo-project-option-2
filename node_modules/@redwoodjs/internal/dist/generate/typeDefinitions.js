...
const generateTypeDefs = async () => {
  ...
  return {
    typeDefFiles: [...generateMirrorDirectoryNamedModules(), ...generateMirrorCells(), ...generateTypeDefRouterPages(), ...generateTypeDefCurrentUser(), ...generateTypeDefRouterRoutes(), ...generateTypeDefGlobImports(), ...generateTypeDefGlobalContext(), ...generateTypeDefScenarios(), ...generateTypeDefTestMocks(), ...generateStubStorybookTypes(), ...gqlApiTypeDefFiles, ...gqlWebTypeDefFiles],
...
`;
  ...
  const hasCliStorybook = (0, _includes.default)(_context5 = (0, _keys.default)(packageJson['devDependencies'])).call(_context5, '@redwoodjs/cli-storybook');
  const hasCliStorybookVite = (0, _includes.default)(_context6 = (0, _keys.default)(packageJson['devDependencies'])).call(_context6, '@redwoodjs/cli-storybook-vite');
